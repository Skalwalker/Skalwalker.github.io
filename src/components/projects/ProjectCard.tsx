...
class ExternalCard extends React.Component<myProps, myState> {
    render() {
        return (
            <a target={this.props.project?.target} rel="noopener noreferrer" href={this.props.project?.url}> 
            <ProjectCardContent project={this.props.project}/>
            </a>
        )
    }
...
class ProjectCard extends React.Component<myProps, myState> {
    ...
    render() {
        ...
        return(
            <>
                {card_type ?  <ExternalCard project={this.props.project}/> : <InternalCard project={this.props.project}/>}
            </>
        )
    }
}

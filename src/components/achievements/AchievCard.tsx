          ...
          <Row>
            ...
            <Col xl={9} md={9} sm={9} xs={9} style={{paddingLeft: "0"}}>
              <Card.Body style={{padding: '0.5rem', paddingLeft: '0'}}>
                <Card.Title className='subtitle_bold pt-2 mb-1' style={{fontSize: '18px'}}>{this.props.title}</Card.Title>
                <Card.Text className='paragraph mb-1' style={{fontSize: '12px'}}>{this.props.date}</Card.Text>
              </Card.Body>
            </Col>
          </Row>
          </Col>

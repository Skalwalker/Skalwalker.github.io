            ...
            <Row>
              ...
              <Col md={12} className=''>
                <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/rk_nobre/">
                  <FaInstagram color="#60D7F9" className='d-inline-block float-end ms-2' size="40"></FaInstagram>
                </a>
                <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/rk-nobre/">
                  <FaLinkedin color="#60D7F9" className='d-inline-block float-end ms-2' size="40"></FaLinkedin>
                </a>
                <a target="_blank" rel="noopener noreferrer" href="https://github.com/Skalwalker">
                  <FaGithub color="#60D7F9" className='d-inline-block float-end ms-2' size="40"></FaGithub>
                </a>

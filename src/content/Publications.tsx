const publications_content = {
    ...
    publications: [
        ...
        {
            title: "Find, Fuse, Fight: Genetic Algorithms to Provide Engaging Content for Multiplayer Augmented Reality Games",
            year: "2022",
        ...
        {
            title: "HOsT: Towards a Low-Cost Fog Solution via Smart Objects to Deal with the Heterogeneity of Data in a Residential Environment",
            year: "2022",

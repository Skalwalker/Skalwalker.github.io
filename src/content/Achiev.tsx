const achievs = [
    {
        title: "Graduate",
        desc: "Got my B.S. in Computer Science at the University of Brasilia. It was not easy, but I made it! My university degree is available under request, just send me an email.",
    ...
    {
        title: "Study Abroad",
        desc: "Went to study in Santa Barbara for my Junior Year of High School. Leaving Brazil and going to another country were such an enlightening experience, I learned a lot about American culture and developed my English to a higher level.",
    ...
    {
        title: "On My Own",
        desc: "Did a Freelance. This experience was highly enriching, being my own boss, setting my own times, and communicating with my clients properly, were some of the many experiences I developed during the project.",
        img: "ios",
        locked: false,
    ...
    },
    {
        ...
        desc: "Inspired by Ron Finley and his project, I started planting my own garden an growing my own food. In a while, I hope to have gathered enough experience to help transform food deserts in food forests and help spread his dream of edible gardens, one city at a time.",
        earned: "Earned in 2020",
        img: "plants",
        locked: false,
        attachment: true,
    ...
    {
        title: "Workshop",
        desc: "Presented a Workshop on the data mining python library I developed to extract information from a 'Diário Oficial'. This project was made during my time working at the Department of Computer Science and this workshop was presented to members of the state government.",
        earned: "Earned in 2020",
        img: "workshop",
        locked: false,
        attachment: true,
        attc_content: "Watch the Video, See Projected"
    },
    {
        title: "Money Maker",
    ...
    {
        title: "Early Start",
        desc: "Published an iOS App in high school, before starting my bachelor’s in Computer Science. I made two apps using XCode and Swift: My Zip Code and Quote's Book. You can't find these apps in the store anymore because the apple developer account is too expensive to maintain, but checkout does projects in my crafts.",
    ...
    },
    {
        ...
        desc: "Work for one of the giants at Silicon Valley. Since I was a child I looked forward to being at the center of innovation and technology. If you are in one of those companies, you can help me unlock this achievement by hiring me!",
        img: "valley",
        locked: true,
        earned: "Achievement Locked",
        attachment: false,
    ...
    {
        title: "Fancy Chef",
        desc: "Cook a fancy dinner to people I don't know. Just like working for a fancy restaurant big chef for one night.",
        img: "cook",
        locked: true,
        earned: "Achievement Locked",
        attachment: false,
    ...
    {
        title: "Barista",
        desc: "I want to become a certified barista and learn the art to make and appreciate coffee.",
        img: "coffee",
        locked: true,
        earned: "Achievement Locked",
        attachment: false,
